  ...
  const projects = [
    {
      ...
      description:
        "A Django-powered ice cream shop where users can browse flavors, manage their cart, and place orders. Includes secure authentication, product browsing, and a responsive Bootstrap design.",
      technologies: [
        "Python",
        "Django",
        "HTML",
    ...
    },
    {
      ...
      description:
        "A modern and responsive movie discovery platform that lets users browse trending films from TMDB, add favorites to a wishlist, and persist selections using localStorage.",
      technologies: [
        "React",
        "JavaScript (ES6+)",
        "Bootstrap",
